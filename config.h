...
static const char col_cyan[]        = "#2060b5";
static const unsigned int baralpha = 0xD6;
...
/* tagging */
static const char *tags[] = { "www", "dev", "sys", "tool", "pass", "task", "chat", "mail", "mus" };
...
static const Rule rules[] = {
    ...
    { "jetbrains-rider",    NULL,       NULL,           1 << 1,       0,           -1 },
	{ "jetbrains-webstorm", NULL,       NULL,           1 << 1,       0,           -1 },
    { "KeePassXC",          NULL,       NULL,           1 << 4,       0,           1 },
    { "discord",            NULL,       NULL,           1 << 6,       0,           1 },
    { "Thunderbird",        NULL,       NULL,           1 << 7,       0,           1 },
    { NULL,                 NULL,       "ncmpcpp",      1 << 8,       0,           1 },
    { NULL,                 NULL,       "timewadd",     0,            1,           -1 },
...
static const Key keys[] = {
    ...
    { 0, XF86XK_AudioRaiseVolume,   spawn,                     SHCMD("pamixer -i 2 && pkill -44 dwmblocks") },
    { 0, XF86XK_AudioLowerVolume,   spawn,                     SHCMD("pamixer -d 2 && pkill -44 dwmblocks") },
    { 0, XF86XK_AudioPlay,          spawn,                     SHCMD("mpc toggle") },
    { MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("mpc toggle") },
    { 0, XF86XK_AudioStop,          spawn,                     SHCMD("mpc stop") },
    { 0, XF86XK_AudioNext,          spawn,                     SHCMD("mpc next") },
    { MODKEY|ShiftMask,             XK_a,      spawn,          SHCMD("mpc next") },
    { 0, XF86XK_AudioPrev,          spawn,                     SHCMD("mpc prev") },
    { MODKEY|ShiftMask,             XK_z,      spawn,          SHCMD("mpc prev") },
    { 0, XF86XK_AudioRewind,        spawn,                     SHCMD("mpc seek -10") },
    { 0, XF86XK_AudioForward,       spawn,                     SHCMD("mpc seek +10") },
    { MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("gpick -o -s | xclip -sel c") },
    { MODKEY,                       XK_Print,  spawn,          SHCMD("maim -sqlB -b 3 -c '255,0,0,0.5' | xclip -selection clipboard -t image/png") },
    { MODKEY|ShiftMask,             XK_Print,  spawn,          SHCMD("maim -sqlB -b 3 -c '255,0,0,0.5' -d 4 | xclip -selection clipboard -t image/png") },
    { MODKEY,                       XK_Pause,  spawn,          SHCMD("lock") },
};
